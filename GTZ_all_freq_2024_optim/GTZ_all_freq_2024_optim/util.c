...
int sample, gtz_out[8],gtz_out_otis[8];
int flag = 0;
short input_samp1, input_samp2;
...
mpy2ll applied and shifting  000000270000000d  */
	...
	for(n=0;n<8;n++) {
		...
		//printf("\n two freq %.16llx 697Hz %x 770Hz %x \n", prod1_0697_0777, prod1_0697,prod1_0777);
		//printf("\n product 1: %x 660Hz product 2: %x 660Hz product 3: %x 660Hz\n", prod1f1,prod2f1,prod3f1);
		//printf("\n sing freq task product 1: %x 660Hz s .f .t product 2: %x 660Hz s .f .t product 3: %x 660Hz\n", prod1660Hz, prod2660Hz,prod3660Hz);
		...
		printf("\n GTZ optimised: %d %d %d %d %d %d %d %d", gtz_out[0],gtz_out[1],gtz_out[2],gtz_out[3],gtz_out[4],gtz_out[5],gtz_out[6],gtz_out[7]);
		printf("\n GTZ Otis: %d %d %d %d %d %d %d %d", gtz_out_otis[0],gtz_out_otis[1],gtz_out_otis[2],gtz_out_otis[3],gtz_out_otis[4],gtz_out_otis[5],gtz_out_otis[6],gtz_out_otis[7]);
